...
var _loginticket = require("./loginticket.js");

var _loginticket2 = _interopRequireDefault(_loginticket);

var _pemverifier = require("./../pemverifier.js");

var _pemverifier2 = _interopRequireDefault(_pemverifier);

var _util = require("util");

var _util2 = _interopRequireDefault(_util);

var _authclient = require("./authclient.js");
...
var mod_OAuth2Client = OAuth2Client;
...
var AuthClient = _authclient2.default;
var util = _util2.default;
var PemVerifier = _pemverifier2.default;
...
OAuth2Client.prototype.revokeToken = function (token, opt_callback) {
  this.transporter.request({
    uri: OAuth2Client.GOOGLE_OAUTH2_REVOKE_URL_ + '?' + querystring.stringify({ token: token }),
    json: true
  }, opt_callback);
};
...
OAuth2Client.prototype.verifyIdToken = function (idToken, audience, callback) {
  ...
  this.getFederatedSignonCerts(function (err, certs) {
    ...
    var login = this.verifySignedJwtWithCerts(idToken, certs, audience, OAuth2Client.ISSUER_);
    if (!login) {
 ...
 */
OAuth2Client.prototype.verifySignedJwtWithCerts = function (jwt, certs, requiredAudience, issuer, maxExpiry) {
...
exports.default = mod_OAuth2Client;
