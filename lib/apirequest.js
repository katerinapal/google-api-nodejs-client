import ext_Multipart from "multipart-stream";
import { utilsjs as utils } from "./utils.js";
import { DefaultTransporter as transporters_DefaultTransporter } from "./transporters.js";
...
function isReadableStream(obj) {
  return obj instanceof ext_stream_stream.Stream && typeof obj._read == 'function' &&
...
function createAPIRequest(parameters, callback) {
  ...
  if (mediaUrl && media && media.body) {
    ...
    if (resource) {
      ...
      body = new ext_Multipart(boundary);
...
var mod_apirequestjs;
export { mod_apirequestjs as apirequestjs };
