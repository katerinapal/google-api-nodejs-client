...
var swig = _swig2.default;
var beautify = _jsBeautify2.default.js_beautify;
var path = _path2.default;
var mkdirp = _mkdirp2.default;
var fs = _fs2.default;
...
function buildurl(input) {
  return ('\'' + BASE_URL + input + '\'').replace(/{\+/g, '\' + params.').replace(/{\//g, '\' + params.').replace(/{/g, '\' + params.').replace(/\*}\'$/g, '').replace(/\*}/g, ' + \'').replace(new RegExp('}\'$', 'g'), '').replace(new RegExp('}', 'g'), ' + \'');
}
