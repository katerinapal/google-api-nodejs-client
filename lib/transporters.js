...
var mod_DefaultTransporter = DefaultTransporter;
...
DefaultTransporter.prototype.configure = function (opts) {
  ...
  opts.headers['User-Agent'] = opts.headers['User-Agent'] ? opts.headers['User-Agent'] + ' ' + this.USER_AGENT : this.USER_AGENT;
  return opts;
};
 ...
 * Wraps request and callback functions.
 */
exports.default = mod_DefaultTransporter;
