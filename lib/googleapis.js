import { Compute as authcomputeclientjs_Compute } from "./auth/computeclient.js";
import { JWT as authjwtclientjs_JWT } from "./auth/jwtclient.js";
import { OAuth2Client as authoauth2clientjs_OAuth2Client } from "./auth/oauth2client.js";
/**
...
function GoogleApis(options) {
  ...
  this.addAPIs(apis);
  this.auth = {
    Compute: authcomputeclientjs_Compute,
    JWT: authjwtclientjs_JWT,
    OAuth2: authoauth2clientjs_OAuth2Client
  };
